...
public class PaymentSteps {
    ...
    public void ıShouldReceiveAListContainingAllPaymentsInTheDatabase() {
        assertThat(paymentList).as("Check if the payment list is not null and not empty")
                .isNotNull()
                .isNotEmpty();
    }
    ...
    public void ıShouldReceiveTheCustomer_idAndStaff_idOfThePaymentWithPayment_id(int paymentId) {
        assertThat(paymentDetails).as("Check if the payment details map is not null and contains the expected customer_id and staff_id")
                .isNotNull()
