...
Feature: validate film values
  ...
  Scenario: Get an film by their ID
    When I request the film with ID 7
    Then I should receive the details of the film with ID 7

  Scenario: Get film's title and description by their ID
    When I request the title and description of the film with ID 17
    Then I should receive the title and description of the film with ID 17